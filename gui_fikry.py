...
with tab2:
    ...
    if st.session_state.selected_cabai in data.columns:
        values = data[st.session_state.selected_cabai]
...
with tab3:
    ...
    # ======================== TAB 3 ======================== with tab3:
        ...
        with col1:
            ...
            train_vals = [results['train_rmse'], results['train_mae'], results['train_r2']*1000]
            test_vals = [results['test_rmse'], results['test_mae'], results['test_r2']*1000]
        ...
        st.info("👆 Klik tombol 'Jalankan Model' di sidebar untuk melatih model")
...
with tab4:
    ...
    if st.session_state.run_model and st.session_state.results:
        ...
        st.info("👆 Jalankan model terlebih dahulu")
